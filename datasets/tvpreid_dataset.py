...
class TVPReidDataset(Dataset):
    ...
    def __init__(self, config: Config, split_type='train', img_transforms=None):
        ...
        db_file = 'data/TVPReid/duke/train.json'
        test_csv = 'data/TVPReid/duke/test.csv'
        train_csv = 'data/TVPReid/duke/train.csv'
    ...
    def _get_vidpath_and_caption_by_index(self, index):
        # return video path and caption as string
        if self.split_type == 'train':
    ...
    def _compute_vid2caption(self):
        ...
        for annotation in self.db['annotations']:
